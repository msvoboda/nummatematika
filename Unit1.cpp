...
Form1->Image1->Canvas->Font->Color = clBlack;
Form1->Image1->Canvas->TextOut(15,2, "Numerická matematika - miskyn@centrum.cz");
...
{
lbBod->Enabled = FALSE;
Title = InputBox("Jméno vkládaného bodu", "", Title);
}
//---------------------------------------------------------------------------
...
Form1->Image1->Canvas->TextOut(10, 20, "Matematické funkce 2.0 alfa");
Form1->Image1->Canvas->Font->Color = clNavy;
Form1->Image1->Canvas->Font->Size = 12;
Form1->Image1->Canvas->TextOut(10, 60, "Created by Miškyn 2003 (c) (miskyn@centrum.cz)");
Form1->Image1->Canvas->TextOut(10, 75, "sky lights");
Form1->Image1->Canvas->TextOut(10, 100, "Tento software je pro volné použití (freeware)");
Form1->Image1->Canvas->TextOut(10, 120, "Bugs:");
Form1->Image1->Canvas->TextOut(10, 145, "Nezjistí body nespojitosti funkce tangens, cotangens.");
Form1->Image1->Canvas->TextOut(10, 165, "Není urèené pro funkce, kde je nutá vysoká pøesnost experimentálního výpoètu.");

Form1->Image1->Canvas->Font->Size = 10;
Form1->Image1->Canvas->Font->Color = clRed;
Form1->Image1->Canvas->TextOut(100, 250, "www.mujweb.cz/www/direktsit/");
Form1->Image1->Canvas->TextOut(100, 270, "www.builder.cz  (pøíklad)");
...
void __fastcall TForm1::Koprovatdoschrnky1Click(TObject *Sender)
{
  ...
  {
     ShowMessage("Nelze zkopírovat do schránky!");
  }
